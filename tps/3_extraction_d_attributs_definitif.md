...
nbgrader:
  ...
  task: false
---
foreground_imgs = [foreground_redness_filter(img, theta=0.75) for img in images]

image_grid(foreground_imgs)

foreground_imgs = [foreground_redness_filter(img, theta=.45)
            for img in images]
...
```{code-cell} ipython3
foreground_imgs = [invert_if_light_background(foreground_redness_filter(img, theta=.45))
            for img in images]
image_grid(foreground_imgs)
```
...
```{code-cell} ipython3
image_grid([contours(np.mean(np.array(img), axis = 2) < 0.01 ) 
            for img in clean_images])
```
...
+++ {"deletable": false, "editable": false, "nbgrader": {"cell_type": "markdown", "checksum": "cd839ff972db0169f1ffedbde7e591b7", "grade": false, "grade_id": "cell-dea972a044f9aaa7", "locked": true, "schema_version": 3, "solution": false, "task": false}}
...
+++ {"deletable": false, "editable": false, "nbgrader": {"cell_type": "markdown", "checksum": "127a2ce11f3bbace08b37987614d51bf", "grade": false, "grade_id": "cell-53b4be052dea2ca4", "locked": true, "schema_version": 3, "solution": false, "task": false}}
...
+++ {"deletable": false, "editable": false, "nbgrader": {"cell_type": "markdown", "checksum": "e33e4bcc0124ea0ae3d101858ba83256", "grade": false, "grade_id": "cell-2a2b1eb294872e13", "locked": true, "schema_version": 3, "solution": false, "task": false}}
...
+++ {"deletable": false, "editable": true, "nbgrader": {"cell_type": "markdown", "checksum": "9460f2448750ebc658df8cb2def0d77a", "grade": false, "grade_id": "cell-793922168d252b11", "locked": true, "schema_version": 3, "solution": false, "task": false}, "slideshow": {"slide_type": ""}, "tags": []}
...
On pense donc qu'il est utile de conserver un attribut, voire un peu plus pour être sûr

+++ {"deletable": false, "editable": false, "nbgrader": {"cell_type": "markdown", "checksum": "99667d049552603b6287ced97c3ae79e", "grade": false, "grade_id": "cell-9006ed5128fae6b4", "locked": true, "schema_version": 3, "solution": false, "task": false}}
...
La paire d'attributs qui donne les meilleures performances est la paire G-(R+B)/2, (G-B)/C. L'approche multivariée n'est pas nécessaire avec les pommes et les bananes parce qu'on sait que redness et elongation peuvent très bien faire l'affaire. Pour notre jeu de données, ce n'est pas non plus nécessaire car avec les attributs précédents ça a bien marché.
