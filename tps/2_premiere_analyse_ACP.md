...
Le nombre de colonnes que nous obtenons représente le nombre de rgb de tous les pixels de chaque image.
...
Non on ne peut pas, il y en a trop
...
Ce score nous semble particulièrement mauvais sûrement parce que les pixels sont difficilement exploitables.
...
on a vu que les pixels étaient difficillement exploitables.
